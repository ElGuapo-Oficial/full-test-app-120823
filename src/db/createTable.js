...
var connection_1 = require("./connection"); // Import the pool instance from your pool module
function createTableIfNotExists() {
    return __awaiter(this, void 0, void 0, function () {
        var client, result, tableExists, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 7:
                    error_1 = _a.sent();
                    console.error('Error creating or checking table:', error_1);
                    return [3 /*break*/, 9];
                case 8:
                    client.release();
                    return [7 /*endfinally*/];
